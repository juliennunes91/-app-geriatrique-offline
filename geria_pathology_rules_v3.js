...
const GUIDELINE_INDEX = {
    ...
    // ---- Sociétés savantes et agences réglementaires ----
    "HAS":              { ref: "Haute Autorité de Santé (France) — Recommandations cliniques. has-sante.fr" },
    "ANSM":             { ref: "Agence nationale de sécurité du médicament et des produits de santé (France). ansm.sante.fr" },
    "FDA":              { ref: "U.S. Food and Drug Administration. fda.gov" },
    "EMA":              { ref: "European Medicines Agency. ema.europa.eu" },
    "NICE":             { ref: "National Institute for Health and Care Excellence (UK). nice.org.uk" },
    "AGS":              { ref: "American Geriatrics Society. americangeriatrics.org" },
    "AASM":             { ref: "American Academy of Sleep Medicine. aasm.org" },
    "EASL":             { ref: "European Association for the Study of the Liver. easl.eu" },
    "ACG":              { ref: "American College of Gastroenterology. gi.org" },
    "ASH":              { ref: "American Society of Hematology. hematology.org" },
    "SFGG":             { ref: "Société Française de Gériatrie et Gérontologie. sfgg.org" },
    "SF3PA":            { ref: "Société Francophone de Psycho-Gériatrie de la Personne Âgée." },
    "SFPC":             { ref: "Société Française de Pharmacie Clinique. sfpc.eu" },
    "SFETD":            { ref: "Société Française d'Étude et de Traitement de la Douleur. sfetd-douleur.org" },
    "SPILF_2024":       { ref: "SPILF 2024. Société de Pathologie Infectieuse de Langue Française — recommandations." },
    "CANMAT":           { ref: "Canadian Network for Mood and Anxiety Treatments. canmat.org" },
    "EWGSOP2":          { ref: "Cruz-Jentoft AJ et al. Age Ageing 2019;48:16. EWGSOP2 Sarcopenia consensus" },
    "EGS_2024":         { ref: "European Geriatric Society — Recommandations 2024" },
    "AAO_PPP_2024":     { ref: "American Academy of Ophthalmology Preferred Practice Pattern 2024" },
    // ---- Mises à jour / versions complémentaires ----
    "KDIGO_2024":       { ref: "KDIGO 2024 Clinical Practice Guidelines. Kidney Int 2024 (collection complète)" },
    "GOLD_2025":        { ref: "GOLD 2025. Global Strategy for Prevention, Diagnosis and Management of COPD 2025" },
    "EULAR_2023":       { ref: "EULAR 2023 — European Alliance of Associations for Rheumatology recommendations" },
    // ---- Essais cliniques majeurs cités ----
    "PARADIGM":         { ref: "McMurray JJV et al. N Engl J Med 2014;371:993. PARADIGM-HF (Sacubitril/valsartan vs énalapril dans HFrEF)" },
    "PARADIGM-HF":      { ref: "McMurray JJV et al. N Engl J Med 2014;371:993. PARADIGM-HF (Sacubitril/valsartan vs énalapril dans HFrEF)" },
    "DAPA-HF":          { ref: "McMurray JJV et al. N Engl J Med 2019;381:1995. DAPA-HF (Dapagliflozine dans HFrEF)" },
    "EMPEROR-Reduced":  { ref: "Packer M et al. N Engl J Med 2020;383:1413. EMPEROR-Reduced (Empagliflozine dans HFrEF)" },
    "EMPEROR-Preserved":{ ref: "Anker SD et al. N Engl J Med 2021;385:1451. EMPEROR-Preserved (Empagliflozine dans HFpEF)" },
    "STRONG-HF":        { ref: "Mebazaa A et al. Lancet 2022;400:1938. STRONG-HF (Optimisation intensive post-décompensation)" },
    "VICTORIA":         { ref: "Armstrong PW et al. N Engl J Med 2020;382:1883. VICTORIA (Vericiguat dans HFrEF post-décompensation)" },
    "SHIFT":            { ref: "Swedberg K et al. Lancet 2010;376:875. SHIFT (Ivabradine dans HFrEF avec FC ≥ 70)" },
    "ANDROMEDA":        { ref: "Køber L et al. N Engl J Med 2008;358:2678. ANDROMEDA (Dronédarone dans IC sévère — augmentation mortalité)" },
    "MOXCON":           { ref: "Cohn JN et al. Eur J Heart Fail 2003;5:659. MOXCON (Moxonidine dans IC — surmortalité)" },
    "TOPCAT":           { ref: "Pitt B et al. N Engl J Med 2014;370:1383. TOPCAT (Spironolactone dans HFpEF)" },
    "ALLHAT":           { ref: "ALLHAT Officers. JAMA 2002;288:2981. ALLHAT (Chlortalidone vs amlodipine vs lisinopril dans HTA)" },
    "ONTARGET":         { ref: "Yusuf S et al. N Engl J Med 2008;358:1547. ONTARGET (Telmisartan, ramipril ou les deux à haut risque CV)" },
    "FIDELIO":          { ref: "Bakris GL et al. N Engl J Med 2020;383:2219. FIDELIO-DKD (Finerenone dans la néphropathie diabétique)" },
    "FIGARO":           { ref: "Pitt B et al. N Engl J Med 2021;385:2252. FIGARO-DKD (Finerenone dans la néphropathie diabétique)" },
    "AFFIRM-AHF":       { ref: "Ponikowski P et al. Lancet 2020;396:1895. AFFIRM-AHF (Carboxymaltose ferrique IV dans HFrEF post-décompensation)" },
    "IRONMAN":          { ref: "Kalra PR et al. Lancet 2022;400:2199. IRONMAN (Dérisomaltose ferrique IV dans HFrEF)" }
};
