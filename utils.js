...
// ── Une case a cocher DECLARE une pathologie ────────────────────────────────
// Table unique, lue dans les DEUX sens :
//   • `_buildPatientContext` (app_analysis.js) l'emploie pour injecter le PAT_xxx
//     dans activeComorbs quand la case est cochee — un fait clinique ne doit pas
//     dependre du chemin de saisie ;
//   • `removeComorb` (app_ui.js) l'INVERSE pour decocher la case quand on retire
//     la pastille. Sans cela la comorbidite etait repoussee a l'analyse suivante :
//     l'ecran n'affichait plus rien, l'analyse la comptait toujours.
