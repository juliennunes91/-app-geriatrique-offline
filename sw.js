// Service Worker - GeriaAssist v0.59 (fixes Entresto self-match, HFrEF ARMi silent skip, SCPD dupli, ESC leak)
// Version auto-incrémentée : modifier BUILD_ID à chaque déploiement
const BUILD_ID = '20260420-rule-fixes';
const CACHE_NAME = `geriaassist-v59-${BUILD_ID}`;
